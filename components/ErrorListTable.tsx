              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <select
                    ...
                    onChange={async (e) => {
                      e.stopPropagation();
                      const newStatus = e.target.value as MasteryStatus;
                      ...
                      try {
                        await recordReview(item.id, ratingMap[newStatus], 20, item);
                        onRefreshData();
                      } catch (err) {
                        console.error('Failed to update status:', err);
                      }
                    }}
                    className={`px-2 py-0.5 rounded-full text-[11px] font-bold cursor-pointer outline-none border border-transparent shadow-2xs ${
